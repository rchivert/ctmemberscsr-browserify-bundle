...
var myCTMemberEditFormCSR;
(function (myCTMemberEditFormCSR) {
    ...
    var loggedInUser = (function () {
        ...
        loggedInUser.HarvestRoleValues = function (results1, results2) {
            ...
            for (var i = 0; i < results1.length; i++) {
                ...
                if (currGroup === groupOwners)
                    loggedInUser.IsSiteOwner = true;
            }
            ;
    ...
    var myCTMemberEditForm = (function () {
        function myCTMemberEditForm() {
        }
        ...
        myCTMemberEditForm.OnPostRenderFunc = function (ctx) {
            ...
            switch (fieldName) {
                case "CTMemberNeedsDataRoomAccess":
                    myCTMemberEditForm.CTMemberNeedsDataRoomAccessID = f.Name + "_" + f.Id + "_\\$" + "BooleanField";
                    break;
                case "Attachments":
                    {
...
})(myCTMemberEditFormCSR || (myCTMemberEditFormCSR = {})); // namespace
